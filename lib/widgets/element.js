...
function Element(options) {
	...
	if (!this.style) {
		...
		this.style.opacity = options.transparent ? 0.5 : options.opacity;
	}
           ...
           */
                 ...
                 */
                    ...
                    || unicode.isCombining(line, j)) {
						...
						i++; // Just keep going and break at element width
					}
					break;
				}
			}
...
Element.prototype.clearPos = function(get, override) {
	...
	if (!lpos) {return;}
	this.screen.clearRegion(lpos.xi, lpos.xl,
		lpos.yi, lpos.yl,
		override);
};
