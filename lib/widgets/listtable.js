...
function ListTable(options) {
	...
	options.rowStyles = options.style.cell.rowStyles || [];
...
ListTable.prototype.setData = function(rows) {
	...
	this.rows.forEach(function(row, i) {
		...
		row.forEach(function(cell, i) {
			...
			const columnStyle = this.rowStyles[i];
			align = columnStyle && columnStyle.align ? columnStyle.align : align;
...
ListTable.prototype.select = function(i) {
	...
	// Trigger event if row is selected
